			...
			<div class="col-md-9">
				<table class="table table-striped">
					...
					<c:forEach var="l_enfer" items="${l_enf}">
						<tr>
							<td>${l_enfer.id_enf}</td>
							<td>${l_enfer.nombre_enf}</td>
							<td>${l_enfer.descripcion_enf}</td>
							<td><a href="/enfermedades/view/${l_enfer.id_enf}"
								class="btn btn-info">View</a> <a
								href="/enfermedades/delete/${l_enfer.id_enf}" class="btn btn-danger">Delete</a>
								<a href="/enfermedades/edit/${l_enfer.id_enf}" class="btn btn-success">Edit</a></td>
						</tr>
					</c:forEach>
				</table>
			</div>
